package org.netbeans.modules.jcup.editor.csl;
...
import static org.netbeans.modules.jcup.editor.csl.JCupLanguage.ACTIONS;
import static org.netbeans.modules.jcup.editor.csl.JCupLanguage.JCUP_MIME_TYPE;
import org.netbeans.modules.jcup.editor.lexer.JCupTokenId;
...
@MIMEResolver.ExtensionRegistration(
        displayName = "Jcup",
        extension = "cup",
        mimeType = JCUP_MIME_TYPE, position = 1
)
@LanguageRegistration(mimeType = JCUP_MIME_TYPE, useMultiview = true)
@ActionReferences({
...
public class JCupLanguage extends DefaultLanguageConfig {
    @StaticResource
    public static final String ICON = "org/netbeans/modules/jcup/editor/resources/icon.png";
        
    public static final String ACTIONS = "Loaders/text/x-jcup/Actions"; //NOI18N
    public static final String JCUP_MIME_TYPE = "text/x-jcup"; //NOI18N

    @NbBundle.Messages("CTL_SourceTabCaption=&Source")
    @MultiViewElement.Registration(
            displayName = "#CTL_SourceTabCaption",
            iconBase = "org/netbeans/modules/jcup/editor/resources/icon.png",
            mimeType = JCupLanguage.JCUP_MIME_TYPE,
    ...
    @Override
    public Language<JCupTokenId> getLexerLanguage() {
        return JCupTokenId.language();
    }
