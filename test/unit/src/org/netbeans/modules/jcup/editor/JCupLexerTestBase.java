 ...
 * @author bhaidu
 */
public class JCupLexerTestBase extends NbTestCase {

    public JCupLexerTestBase(String testName) {
        super(testName);
    }
    ...
    public File getDataDir() {
        ...
        while (ts.moveNext()) {
            ...
            result.append(" “");
            result.append(JCupLexerUtils.replaceLinesAndTabs(text.toString()));
            result.append("“\n");
        }
...
//            if (field.v)
    ...
    protected String getTestResult(String filename) throws Exception {
        String content = JCupLexerUtils.getFileContent(new File(getDataDir(), "testfiles/" + filename));
        TokenSequence<?> ts = JCupLexerUtils.seqForText(content, JCupTokenId.language());
