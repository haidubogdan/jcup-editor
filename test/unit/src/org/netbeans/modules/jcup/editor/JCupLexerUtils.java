 ...
 * @author bhaidu
 */
public class JCupLexerUtils extends TestCase {
    
    public static class LexerResultItem {
        private JCupTokenId tokenId;
        private String text;

        public LexerResultItem(JCupTokenId tokenId, String text) {
    ...
    public static void next(TokenSequence<?> ts, TokenId id, String fixedText) {
        ...
        //assertEquals(JCupTokenId.T_HTML, id);
        ...
        while (line != null) {
            if (line.startsWith("#->[")) {
                ...
                if (index > 0) {
                    ...
                    resultItem = new LexerResultItem(JCupTokenId.valueOf(tokenIdName), text);
